/********************************************************************************
** Form generated from reading UI file 'firstuserregistration.ui'
**
...
#ifndef UI_FIRSTUSERREGISTRATION_H
#define UI_FIRSTUSERREGISTRATION_H
...
class Ui_firstUserRegistration
{
public:
    QFrame *frame;
    ...
    void setupUi(QWidget *firstUserRegistration)
    {
        if (firstUserRegistration->objectName().isEmpty())
            firstUserRegistration->setObjectName("firstUserRegistration");
        firstUserRegistration->resize(800, 500);
        frame = new QFrame(firstUserRegistration);
...
"}"));
        ...
        retranslateUi(firstUserRegistration);

        QMetaObject::connectSlotsByName(firstUserRegistration);
    } // setupUi

    void retranslateUi(QWidget *firstUserRegistration)
    {
        firstUserRegistration->setWindowTitle(QCoreApplication::translate("firstUserRegistration", "Form", nullptr));
        pushButton->setText(QCoreApplication::translate("firstUserRegistration", "Cr\303\251er", nullptr));
        labelConnection->setText(QCoreApplication::translate("firstUserRegistration", "Creation d'un compte", nullptr));
        labelMdp->setText(QCoreApplication::translate("firstUserRegistration", "Mot de Passe :", nullptr));
        labelId->setText(QCoreApplication::translate("firstUserRegistration", "Nom :", nullptr));
        labelConnection_2->setText(QString());
        pushButton_2->setText(QCoreApplication::translate("firstUserRegistration", "Cr\303\251er", nullptr));
        radioButton->setText(QCoreApplication::translate("firstUserRegistration", "Admin", nullptr));
    } // retranslateUi

};

namespace Ui {
    class firstUserRegistration: public Ui_firstUserRegistration {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FIRSTUSERREGISTRATION_H
