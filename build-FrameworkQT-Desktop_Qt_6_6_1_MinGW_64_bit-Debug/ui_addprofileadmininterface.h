/********************************************************************************
** Form generated from reading UI file 'addprofileadmininterface.ui'
**
...
#ifndef UI_ADDPROFILEADMININTERFACE_H
#define UI_ADDPROFILEADMININTERFACE_H
...
class Ui_addProfileAdminInterface
{
public:
    QFrame *frame;
    ...
    void setupUi(QWidget *addProfileAdminInterface)
    {
        if (addProfileAdminInterface->objectName().isEmpty())
            addProfileAdminInterface->setObjectName("addProfileAdminInterface");
        addProfileAdminInterface->resize(800, 500);
        frame = new QFrame(addProfileAdminInterface);
...
"}"));
        ...
        labelQuestion = new QLabel(layoutWidget);
        labelQuestion->setObjectName("labelQuestion");
        labelQuestion->setMaximumSize(QSize(200, 10));
        QFont font2;
        ...
        gridLayout->addWidget(labelQuestion, 0, 0, 1, 1);


        retranslateUi(addProfileAdminInterface);

        QMetaObject::connectSlotsByName(addProfileAdminInterface);
    } // setupUi

    void retranslateUi(QWidget *addProfileAdminInterface)
    {
        addProfileAdminInterface->setWindowTitle(QCoreApplication::translate("addProfileAdminInterface", "Form", nullptr));
        pushButton->setText(QCoreApplication::translate("addProfileAdminInterface", "Valider", nullptr));
        labelConnection->setText(QCoreApplication::translate("addProfileAdminInterface", "Nouveau Profil", nullptr));
        labelId->setText(QCoreApplication::translate("addProfileAdminInterface", "Nom :", nullptr));
        labelQuestion->setText(QCoreApplication::translate("addProfileAdminInterface", "Comment souhaitez vous appeler le profil ?", nullptr));
    } // retranslateUi

};

namespace Ui {
    class addProfileAdminInterface: public Ui_addProfileAdminInterface {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDPROFILEADMININTERFACE_H
