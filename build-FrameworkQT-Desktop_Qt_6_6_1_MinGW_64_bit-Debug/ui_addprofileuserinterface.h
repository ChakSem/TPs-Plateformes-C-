/********************************************************************************
** Form generated from reading UI file 'addprofileuserinterface.ui'
**
...
#ifndef UI_ADDPROFILEUSERINTERFACE_H
#define UI_ADDPROFILEUSERINTERFACE_H
...
class Ui_addProfileUserInterface
{
public:
    QFrame *frame;
    ...
    void setupUi(QWidget *addProfileUserInterface)
    {
        if (addProfileUserInterface->objectName().isEmpty())
            addProfileUserInterface->setObjectName("addProfileUserInterface");
        addProfileUserInterface->resize(800, 500);
        frame = new QFrame(addProfileUserInterface);
...
"}"));
        ...
        retranslateUi(addProfileUserInterface);

        QMetaObject::connectSlotsByName(addProfileUserInterface);
    } // setupUi

    void retranslateUi(QWidget *addProfileUserInterface)
    {
        addProfileUserInterface->setWindowTitle(QCoreApplication::translate("addProfileUserInterface", "Form", nullptr));
        pushButton->setText(QCoreApplication::translate("addProfileUserInterface", "Valider", nullptr));
        labelConnection->setText(QCoreApplication::translate("addProfileUserInterface", "Nouveau Profil", nullptr));
        labelId->setText(QCoreApplication::translate("addProfileUserInterface", "Nom :", nullptr));
        labelConnection_2->setText(QCoreApplication::translate("addProfileUserInterface", "Comment souhaitez vous appeler le profil ?", nullptr));
    } // retranslateUi

};

namespace Ui {
    class addProfileUserInterface: public Ui_addProfileUserInterface {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDPROFILEUSERINTERFACE_H
