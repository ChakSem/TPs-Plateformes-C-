/********************************************************************************
** Form generated from reading UI file 'deconnectioninterface.ui'
**
...
#ifndef UI_DECONNECTIONINTERFACE_H
#define UI_DECONNECTIONINTERFACE_H
...
class Ui_DeconnectionInterface
{
public:
    QPushButton *pushButtonDeconnection;

    void setupUi(QWidget *DeconnectionInterface)
    {
...
"}"));
        ...
        retranslateUi(DeconnectionInterface);

        QMetaObject::connectSlotsByName(DeconnectionInterface);
    } // setupUi

    void retranslateUi(QWidget *DeconnectionInterface)
    {
        DeconnectionInterface->setWindowTitle(QCoreApplication::translate("DeconnectionInterface", "Form", nullptr));
        pushButtonDeconnection->setText(QCoreApplication::translate("DeconnectionInterface", "Se D\303\251connecter", nullptr));
    } // retranslateUi

};

namespace Ui {
    class DeconnectionInterface: public Ui_DeconnectionInterface {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DECONNECTIONINTERFACE_H
